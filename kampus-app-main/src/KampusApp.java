...
public class KampusApp {
    private static final int Prodi = 0;
    ...
    public void menuTambah() {
        ...
        if (db.mahasiswaTbl.isValidProdi(idProdi)) {
            ...
            System.out.println("ID Prodi tidak ditemukan dalam database. Mahasiswa tidak dapat ditambahkan.");
        }
